...
def run_modality_experiment(
    ...
    print("\n" + "=" * 90)
    print(f"Start two-modal fusion: {fusion_name}")
    print("=" * 90)
...
output_root = f"bimodal_fusion_results_{timestamp}"
...
summary_path = os.path.join(output_root, "all_bimodal_fusion_summary.xlsx")
summary_df.to_excel(summary_path, index=False)

print("\n" + "=" * 90)
print("Two-modal fusion experiments finished.")
