...
def run_modality_experiment(
    ...
    print("\n" + "=" * 90)
    print(f"Start single-modal experiment: {fusion_name}")
    print("=" * 90)
...
output_root = f"singlemodal_results_{timestamp}"
...
summary_path = os.path.join(output_root, "all_singlemodal_summary.xlsx")
summary_df.to_excel(summary_path, index=False)

print("\n" + "=" * 90)
print("Single-modal experiments finished.")
